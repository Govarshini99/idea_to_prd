...
#set_property -dict { PACKAGEN D17   IOSTANDARD LVCMOS33 } [get_ports { OV7670_D[2] }]; #IO_L16N_T2_A27_15 Sch=ja[7]
set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS33 } [get_ports { OV7670_D[3] }]; #IO_L16P_T2_A28_15 Sch=ja[8]
set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS33 } [get_ports { OV7670_D[4] }]; #IO_L22N_T3_A16_15 Sch=ja[9]
